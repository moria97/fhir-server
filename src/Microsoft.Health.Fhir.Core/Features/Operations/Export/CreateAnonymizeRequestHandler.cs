...
{
    public class CreateAnonymizeRequestHandler : IRequestHandler<CreateAnonymizeRequest, CreateExportResponse>
    {
        private readonly IClaimsExtractor _claimsExtractor;
        private readonly IFhirOperationDataStore _fhirOperationDataStore;
        private readonly IFhirAuthorizationService _authorizationService;

        public CreateAnonymizeRequestHandler(IClaimsExtractor claimsExtractor, IFhirOperationDataStore fhirOperationDataStore, IFhirAuthorizationService authorizationService)
        {
        ...
        public async Task<CreateExportResponse> Handle(CreateAnonymizeRequest request, CancellationToken cancellationToken)
        {
